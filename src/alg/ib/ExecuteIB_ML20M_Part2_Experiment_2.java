/*
 * Implement a content-based recommender for set of all movies rated more than or equals to 4, by user A
 * 
 * Rajat Agrawal
 * 01/03/2017
 */
...
import alg.ib.predictor.Content_Based_Ratings_Greater_Than_Four;
import alg.ib.predictor.Predictor;
import util.evaluator.Evaluator;
import util.reader.DatasetReader;

public class ExecuteIB_ML20M_Part2_Experiment_2 {
	public static void main(String[] args)
	{
		System.out.println("Content Based Approach:\n"
				+ "Prediction based on movies which are rated >=  4 by user A\n"
				+ "=============================================");
		// configure the item-based CF algorithm - set the predictor, neighbourhood and similarity metric ...
		Predictor predictor = new Content_Based_Ratings_Greater_Than_Four();
		...
		String outputFile = "results" + File.separator + "predictions_Part2_Exp2.txt";
